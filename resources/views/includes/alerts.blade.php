...
<div class="alert alert-success alert-dismissible fade show alerts mb-3 mx-4 px-3 py-2" role="alert">
    <span class="font-size-sm"><i data-feather="check"></i> {{ session()->get('success') }}</span>
...
<div class="alert alert-danger alert-dismissible fade show alerts mb-3 mx-4 px-3 py-2" role="alert">
    <span class="font-size-sm"><i data-feather="alert-circle"></i> {{ session()->get('error') }}</span>
    <button type="button" class="close px-3 py-2" data-dismiss="alert" aria-label="Close">
        <span aria-hidden="true" class="dismiss-icon"><i data-feather="x"></i> </span>
    </button>
</div>
...
<div class="alert alert-success alert-dismissible fade show alerts mb-3 mx-4 px-3 py-2" role="alert">
    <span class="font-size-sm"><i data-feather="alert-triangle"></i> {{ session()->get('warning') }}</span>
    <button type="button" class="close px-3 py-2" data-dismiss="alert" aria-label="Close">
        <span aria-hidden="true" class="dismiss-icon"><i data-feather="x"></i> </span>
    </button>
</div>
...
<div class="alert alert-success alert-dismissible fade show alerts mb-3 mx-4 px-3 py-2" role="alert">
    <span class="font-size-sm"><i data-feather="check"></i> {{ session()->get('import') }}</span>
    <button type="button" class="close px-3 py-2" data-dismiss="alert" aria-label="Close">
        <span aria-hidden="true" class="dismiss-icon"><i data-feather="x"></i> </span>
    </button>
</div>
...
<div class="alert alert-success alert-dismissible fade show alerts mb-3 mx-4 px-3 py-2" role="alert">
    <span class="font-size-sm"><i data-feather="alert-circle"></i> {{ session()->get('import_failed') }}</span>
    <button type="button" class="close px-3 py-2" data-dismiss="alert" aria-label="Close">
        <span aria-hidden="true" class="dismiss-icon"><i data-feather="x"></i> </span>
    </button>
</div>
...
<div class="alert alert-success alert-dismissible fade show alerts mb-3 px-2 py-1" role="alert">
    <span class="font-size-sm"><i data-feather="check"></i> {{ session()->get('password-success') }}</span>
