...
$(document).ready(function(){
    ...
    columnDefs = {
        ...
        cellRenderer: function(params){
            ...
            var edit_url = '{{ route("property_owners.edit", ":id") }}';
    ...
    $('#btn-import-submit').on('click', function(){
        ...
        document.getElementById("import-form-submit").action = "{{ route('property_owners.import') }}";
    ...
    $('#btn-remove').on('click', function(){
        var destroy = '{{ route("property_owners.destroy", ":id") }}';
