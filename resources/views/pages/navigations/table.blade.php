    ...
    <table class="table">
        <thead>
            <tr>
                ...
                <th scope="col" class="font-weight-600">Route</th>
                <th scope="col" class="font-weight-600">Controller</th>
                <th scope="col" class="font-weight-600">Order</th>
                <th scope="col" class="font-weight-600"></th>
            </tr>
        </thead>
